...
class LiquorshopDetailed extends StatefulWidget {
  static const route = '/LiquorshopDetailedd';

  @override
  _LiquorshopDetailedState createState() => _LiquorshopDetailedState();
}

class _LiquorshopDetailedState extends State<LiquorshopDetailed>
      ...
      child: GridView.builder(
        ...
        itemBuilder: (context, index) {
          return ShopCardForAll(
            ...
            imageUrl: wineShop,
            route: LiquorshopDetailed.route,
          );
        },
      ),
    );
