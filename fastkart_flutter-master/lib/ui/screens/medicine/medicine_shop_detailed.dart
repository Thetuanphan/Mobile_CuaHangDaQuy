...
class MedicineShopDetailed extends StatefulWidget {
  static const route = '/MedicineShopDetailedd';

  @override
  _MedicineShopDetailedState createState() => _MedicineShopDetailedState();
}

class _MedicineShopDetailedState extends State<MedicineShopDetailed>
                              ...
                              children: [
                                ...
                                Column(
                                  ...
                                  children: [
                                    ...
                                    Text(
                                      'Upload your Prescription & we do the rest',
                                      style: TextStyle(
                                          color: Colors.white,
                                          fontSize:
                                              SizeConfig.blockSizeHorizontal *
                                    ...
                                    GestureDetector(
                                      onTap: () {
                                        Navigator.pushNamed(context,
                                            PrescriptionUploadScreen.route);
                                      },
                                      child: Container(
